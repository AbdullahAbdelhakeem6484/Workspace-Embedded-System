...
void SynchronousDisplay(u8 data)
{
...
void GetData()
{
	u8 temp=0;/*To get into the loop for the first time and hold the value of the key pressed*/
...
s64 ConvertToInt64(u8 * ptr,u8 len)
{
	u8 index;
	s64 value=0;/*the value which will be returned*/
...
void Analyze()
{
	s8 TempArr[MaxNumberOfDigits]={0};
	u8 TempIndex=0;
	u8 index=0;
