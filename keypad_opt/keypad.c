  ...
  for (LOC_u8Column = 0 + COL_INIT; LOC_u8Column < COL_FIN; LOC_u8Column++)
  {
    ...
    for (LOC_u8Row = 0 + ROW_INIT; LOC_u8Row < ROW_FIN; LOC_u8Row++)
    {
      ...
      if (!DIO_voidSetPinValue(PORT, LOC_u8Row))
      {
        ...
        while (!DIO_voidSetPinValue(PORT, LOC_u8Row))
          ;
    ...
    DIO_voidSetPinValue(PORT, LOC_u8Column, STD_HIGH);
  }
